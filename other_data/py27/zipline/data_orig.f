...
unique
unique
with equity daily bar data
numerical expression
transaction with wrong direction
tmp bar reader
aroon
end
blaze estimates loader
sequential pool
per dollar
set benchmark outside initialize
reindex bar reader
with bcolz future minute bar reader
data frame loader
max drawdown
...
bad callable
expiring cache
empty positions algorithm
unsupported pipeline output
not half day
market impact base
too many arguments
not callable
unsupported data type
iceexchange calendar
exponential weighted factor
all
no such pipeline
bound column descr
sub period divider
no engine registered
minute bar update reader
custom classifier
with seeded random pipeline engine
pipeline date error
no restrictions
time
risk metrics cumulative
unknown bundle
expr data
restricted dtype mixin
sid assignment error
static sids
pipeline output during initialize
adjusted
business days until next event
with trading calendars
stateful rule
any
null filter
with bcolz equity daily bar reader
num expr filter
cancel policy
trading algorithm
input dates
daily history aggregator
moving average convergence divergence signal
tmp assets db
window length too long
missing value mismatch
bad clean
exception algorithm
indexes
invalid term params
term inputs not specified
set commission post init
schedule function without calendar
trading calendar dispatcher
adjusted
bad binary operator
tmp bcolz equity daily bar reader
with bcolz equity minute bar reader
pricing data associable
...
argument
with data portal
with equity minute bar data
invalid order algorithm
order in before trading start
asset convertible
column
term outputs empty
after open
...
precomputed loader
rolling spearman of returns
finaldescriptor
non window safe input
eodcancel
unsupported datetime format
with future minute bar data
...
volume roll finder
rank
specific equity trades
linear weighted moving average
category mismatch
run algo error
non sliceable term
no value for sid
with trading sessions
with instance tmp dir
talibalgorithm
dataframe cache
unsupported slippage model
with sim params
test order style forwarding algorithm
lazyval
stocks
...
bcolz daily bar writer
classifier
annualized volatility
equity commission model
window length not specified
multiple symbols found
sqlite adjustment reader
asset dbwriter
not dtype
trading control violation
asset dispatch bar reader
test algorithm
trading control
max order size
history loader
...
percentile filter
latest
lseexchange calendar
incompatible history frequency
data set meta
nullctx
mutable index rolling panel
roll finder
before close
usequity pricing loader
...
testing slippage
asset date bounds
sqlite adjustment writer
bad order parameters
term graph
weighted average value
timedelta
unsupported cancel policy
positive window length mixin
...
account control violation
with bcolz equity daily bar reader from csvs
bad percentile bounds
never
bollinger bands
invalid output name
transaction with no volume
schedule function invalid calendar
cannot order delisted asset
reindex minute bar reader
num expr factor
volatility volume share
history in initialize
sliding window
nop context
set portfolio algorithm
ichimoku kinko hyo
cyclic calendar alias
...
rolling panel
nyseexchange calendar
stateless rule
latest mixin
rsi
vwap
value not found for field
calendar roll finder
wrong data for transform
transaction with no amount
with tmp dir
bcolz minute bar metadata
event
unknown rank method
with responses
event manager
...
downsampled mixin
start
future slippage model
blaze events loader
rolling pearson
events loader
attach pipeline after initialize
bmfexchange calendar
filter
asset dbversion error
account
incompatible slippage model
seeded random loader
heavy buy algorithm
recarray field
loadable term
symbol not found
...
bcolz minute bar writer
exploding object
session bar reader
null adjustment reader
everything
reindex session bar reader
exploding pipeline engine
tmp bcolz equity minute bar reader
limit order
quantopian usfutures calendar
static assets
quantiles
working file
at least n
split adjusted estimates loader
multiple values found for sid
classproperty
timestamp
ndays before last trading day of month
grouped row transform
noop algorithm
composed rule
tmp trading env
unsupported dtype
future commission model
with default date bounds
ambitious stop limit algorithm
simple pipeline engine
transaction volume exceeds order
volume share slippage
no data on date
wildcard
invalid calendar name
no further data error
no meta data warning
mismatched arguments
rolling pearson of returns
max leverage
ndays before last trading day of week
long only
single input mixin
label array
final meta
single asset
set asset date bounds algorithm
sids not found
continuous future adjustment reader
expired
factor
latest
with asset finder
...
finalvalue
usequity pricing
exponential weighted moving std dev
zipline api
static restrictions
earnings estimates loader
trading calendar
cmeexchange calendar
standard outputs
h5minute bar update writer
blaze loader
computable term
per contract
latest
...
incompatible commission model
max order count
window length not positive
per share
h5minute bar update reader
consume asset meta data error
map asset identifier index error
pipeline loader
callback manager
nth trading day of week
record batch blotter
working dir
restricted list order
trading environment
rolling linear regression of returns
equity slippage model
max position size
zipline test case
unsupported commission model
tsxexchange calendar
with adjustment reader
