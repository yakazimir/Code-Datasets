...
Data Fixed E1
Foreign ForeignPtr Safe
Control Exception Base ArrayException
Data Fixed E2
...
Foreign ForeignPtr FinalizerEnvPtr env a
Data Fixed E12
GHC Generics C
GHC IO Device IODeviceType
Prelude String
Prelude ReadS a
Foreign ForeignPtr Safe FinalizerEnvPtr env a
...
Numeric Natural
Control Exception Base AsyncException
...
Data Complex
Control Monad ST Lazy Safe RealWorld
Data Typeable TyCon
