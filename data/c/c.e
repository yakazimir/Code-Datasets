...
wide character array to copy from
...
null-terminated wide string to examine
null-terminated wide string to append to
arguments specifying data to print
system-specific locale identifier
the file stream to set the buffer to
first element of the array where the transformed string will be written
...
floating point value
null-terminated byte string to tokenize
bitmask listing the exception flags to clear
complex argument
null-terminated byte string to be analyzed
atomic object to modify
time_t object specifying the time to print
the wide character to map
condition variable
floating point values
wide character
floating point value representing angle in radians
null-terminated byte string to be interpreted
exit status of the program
number of wide characters to examine
floating point value
variable to store identifier of the condition variable to
the file stream to write out
the file to reset the error flags for
location where the resulting wide character will be written
wide character array to be examined
size_t object where the result will be stored
conversion state used when interpreting the multibyte string
null-terminated wide string to be interpreted
character to classify
character to be pushed into the input stream buffer
atomic flag object to modify
size_t object where the result will be stored
...
null-terminated wide string that contains the characters to search for
object to put the remaining time on interruption
complex argument
maximum number of characters to write typically the size of the destination buffer
null-terminated byte string to search for
null-terminated wide string to search for
character string to be written
buffer for the stream to use
...
tm object specifying the time to print
multibyte character string used as input
mbstate_t object to examine
floating point values
null-terminated wide string to copy from
...
floating point value representing angle in radians
floating point value
wide character array to copy to
null-terminated byte string to append to
complex argument
complex argument
array where the read objects are stored
the type of the next parameter in ap
null-terminated wide string to copy from
null-terminated wide string to append to
null-terminated byte string to duplicate
complex argument
null-terminated string containing the path identifying the file to rename
wide character string to write to
user-provided buffer
variable holding the conversion state
complex argument
pointer to narrow character array where the multibyte character will be stored
first element of the char array for output
character to be converted
pointer to narrow character array where the multibyte character will be stored
integer value
maximum number of wide characters to copy
null-terminated byte string identifying delimiters
...
mutex to unlock for the duration of the block
complex argument
null-terminated byte string to be interpreted
null-terminated character string to read from
fpos_t object to store the file position indicator to
the value to add to the value stored in the atomic object
wide character
wide character
multibyte character string used as input
null-terminated byte string to be interpreted
character array to write to
n object of type struct timespec
the file stream to check
pointer to character
max number of wide characters to write the size of the destination buffer
function to be called on normal program termination
...
conversion state object used when interpreting the multibyte string
maximum number of characters to write typically the length of str
limit on the number of bytes in s that can be examined
wide string to write to
...
floating point value representing a hyperbolic angle
floating point value
n element of a multibyte character string
limit on the number of bytes in s that can be examined
multibyte character string used as input
n element of a char array
wide character to search for
character array to copy to
number of element in the array
first element of the wchar_t array for output
base of the interpreted integer value
conversion state object used when interpreting the multibyte string
new size of the array
complex argument
null-terminated byte string that contains the characters to search for
number of wide characters to fill
exit status of the program
output stream
floating point value representing the area of a hyperbolic sector
receiving arguments
memory area to be reallocated
the output stream
floating point value
floating point value
the value to return from setjmp
floating point values
null-terminated byte string to be analyzed
...
pointer where the function stores the result an out-parameter
...
null-terminated wide string to be examined
null-terminated byte string to duplicate
complex argument
floating point value
expression of scalar type
number of bytes to allocate
locale category identifier one of the lc_xxx macros
wide character
the lc_ctype category obtained from a call to wctype
first element of a null-terminated multibyte string to convert
conversion state object
null-terminated wide string to read from
single-byte character to widen
floating point values
output stream
the memory ordering executed by this fence
null-terminated wide string to tokenize
the value to replace the atomic object with
first element of a null-terminated wide string to convert
null-terminated string containing the path identifying the file to delete
floating point value
conversion state object used when interpreting the multibyte string
time_t object to convert
character to classify
floating point value
character string to be written
floating point value
null-terminated string with explanatory message
character to classify
floating point value
floating point value
...
file stream to modify
object of type fenv_t which holds the status of the floating-point environment
up to bufsz - 1 characters may be written plus the null terminator
floating point value
variable referring to the execution state of the program saved by setjmp
character string to write to
maximum number of wide characters to write
the size of the destination buffer
null-terminated byte string that contains the characters to search for
pointer to a wide character
receiving arguments
null-terminated wide string to be analyzed
variable to save the execution state of the program to
location where the resulting 16-bit character will be written
first object in the array to be written
wide character
complex argument
size of each object
null-terminated byte string to be examined
floating point values
fill byte
null-terminated string containing the new path of the file
...
wide character array to fill
character to classify
number of wide characters to copy
atomic object to modify
wide character to search for
maximum number of bytes to write
character string identifying the command to be run in the command processor
...
null-terminated byte string to copy from
number of bytes to allocate
floating point value
pointer to narrow character array where the multibyte character will be stored
...
null-terminated byte string to be analyzed
pointers to the null-terminated wide strings to compare
character array to copy from
object specifying timeout time to wait until
character to classify
...
user-provided location where getenv_s will store the length of the environment variable
floating point value
floating point value
input file stream to read from
floating point value
...
c i/o stream to modify or query
null-terminated byte string to append to
...
floating point value
base of the interpreted integer value
tm object specifying local calendar time to convert
...
location where the resulting 32-bit character will be written
null-terminated byte string to examine
object to fill
null-terminated wide string to be analyzed
...
number of wide characters available in the array pointed to by dst
atomic object to modify
struct tm object specifying the time to format
...
maximum number of characters to write typically the size of the destination buffer
n element of a char array of size at least bufsz
max number of bytes to write the size of the buffer s
wide character
wide character array to copy to
null-terminated wide string identifying delimiters
condition variable to block on
the memory synchronization ordering for this operation all values are permitted
an instance of the va_list type
pointer to narrow character array where the multibyte character will be stored
wide character
null-terminated wide string to be written
atomic object to access
character to classify
conversion state object
null-terminated wide string to be analyzed
character to classify
...
maximum number of characters to write typically the size of the destination buffer
fpos_t object to use as new value of file position indicator
conversion state object used when interpreting the multibyte string
first character of a null-terminated byte string to transform
null-terminated wide string to be interpreted
struct tm object to store the result
mutex to unlock
mutex to unlock for the duration of the block
conversion state object used when interpreting the multibyte string
floating point value
...
timeout time to wait until
the length of str
user-supplied buffer at least 26 bytes in length
max number of wide characters that will be written size of the dst array
